...
- [x] Explain what a token is used for.
      ...
      A unique identifier for an application requesting access

- [x] What steps can you take in your web apps to keep your data secure?

      make sure that authentication is in place

- [x] Describe how web servers work.

      a server returns web page information from a web provider
